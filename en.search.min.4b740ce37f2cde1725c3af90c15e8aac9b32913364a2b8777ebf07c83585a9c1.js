...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2cd15f34b854211fed591a60981bc1e7f025cf3f1560dfa34400757107270ee2.js',function(){input.required=false;search();});}
